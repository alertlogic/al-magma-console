...
import { AlStateFilterDescriptor } from '@al/ng-generic-components';
...
export class MenuExamplesComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.stateFilters=[
            { value:{ label:'Active', iconClass: 'material-icons', icon: 'check_circle', showTotal: false }},
            { value:{ label:'Inactive', iconClass: 'material-icons', icon: 'block', showTotal: true, totalShowing:12, total:15 }},
            { value:{ label:'Deleted', iconClass: 'material-icons', icon: 'delete', showTotal: false }}
        ];
        this.selectedState = this.stateFilters[0].value;
