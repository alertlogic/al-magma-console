import { unhealthyAppliancesByTopAccounts } from '../unhealthy_appliances_by_top_accounts.transformation';
import { ZeroStateReason } from '@al/ng-visualizations-components';

describe('Transformation Utilities Test Suite: Unhealthy Appliances By Top Accounts', () => {
  describe('when calling missingAgentsByTopAccounts', () => {
    it('should return a ZeroStateReason when there is no data', () => {
      ...
      expect(unhealthyAppliancesByTopAccounts(response)).toEqual(expected);
    });
    ...
    it('should return the correct object when a valid response is passed in', () => {
      ...
      const expected = {
        ...
        description: "Unhealthy Appliances",
        inverted: true,
        yAxisType: 'linear',
