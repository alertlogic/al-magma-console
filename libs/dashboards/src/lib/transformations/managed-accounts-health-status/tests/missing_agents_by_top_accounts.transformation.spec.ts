import { missingAgentsByTopAccounts } from '../missing_agents_by_top_accounts.transformation';
import { ZeroStateReason } from '@al/ng-visualizations-components';

describe('Transformation Utilities Test Suite: Missing Agents By Top Accounts', () => {
  describe('when calling missingAgentsByTopAccounts', () => {
    it('should return a ZeroStateReason when there is no data', () => {
      ...
      expect(missingAgentsByTopAccounts(response)).toEqual(expected);
    });
