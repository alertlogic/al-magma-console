...
/**
 * topCredentialStuffingUsers transformation
 * kalm: dashboards_auth_top_credential_stuffing_users
 * @param response - Raw data from API
 */
export const topCredentialStuffingUsers = (response: { rows: any[][], column_info: { type: string, name: string }[] }): TableListConfig | ZeroState => {
