...
export class ErrorService {
    ...
    public messages: { [key: string]: any } = {
        'exposures': {
            "generic": {
                "error_400": "There was an issue processing your exposures request. Please try again later. If this error continues, contact Alert Logic Support.",
        ...
        'deployments': {
            "generic": {
                "error_404": "There was an issue processing your deployments request. Please try again later. If this error continues, contact Alert Logic Support."
            }
        }
    };
    ...
    */
    public getMessage = (api: any, subApi: any, key: any): string => {
        // default message
