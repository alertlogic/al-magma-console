...
import { AlDropdownListComponent } from './al-dropdown-list.component';
...
describe("AlMultiSelectListComponent", () => {
    let component: AlDropdownListComponent<MockValue>;
    let fixture: ComponentFixture<AlDropdownListComponent<MockValue>>;
    ...
    beforeEach(() => {
        ...
        TestBed.configureTestingModule({
            declarations: [AlDropdownListComponent],
            imports: [
                TooltipModule,
                ChipsModule,
                MultiSelectModule
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent<AlDropdownListComponent<MockValue>>(AlDropdownListComponent);
