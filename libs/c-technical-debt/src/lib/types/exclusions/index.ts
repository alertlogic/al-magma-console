/**
 *  A bunch of classes to describe exclutions-rules-related structures.
 *
...
/**
 *  ExclusionsRulesDescriptor provides a class to describe any exclusion rule, along with its
...
export class ExclusionsRulesDescriptor {
    ...
    public update(rule: ExclusionsRulesDescriptor) {
        this.id          = rule.id;
        this.name        = rule.name;
